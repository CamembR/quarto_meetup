...
::: columns
::: {.column width="38%"}
![](images/paste-86FE818A.png){fig-align="center"}
:::

::: {.column width="62%"}
![](images/paste-CEC3CDF6.png)
:::
:::
...
Un bouton `Render` pour générer le document

![](images/paste-CEC3CDF6.png){fig-align="center" width="715"}
