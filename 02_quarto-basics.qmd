...
-   Version $\beta$ disponible depuis Avril 2022 + révélation de Quarto lors de la Conférence RStudio[^1] cet été
...
[![Plusieurs languages en entrée, plusieus languages en sortie et un seul intermédiaire !](images/3-teach/many-lang-qmd-to-output.png){fig-align="center" width="957"}](https://posit.co/keynotes/hello-quarto-share-collaborate-teach-reimagine/)
...
-   Une fois tout ok, installation du package eponyme quarto
