...
# Une histoire du Notebook  {.title-middle-dark background-image="images/horst_quarto_penguins_share.png" aria-label="Two happy penguins taking a selfie together in a snowy landscape."}


## Une definition  {#definition .center data-menu-title="Definition"}
