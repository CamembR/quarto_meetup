...
##  {#demo-share .centered data-menu-title="Demo: Share" background-video="videos/demo-multi_output.webm" background-size="contain" background-color="#FFFFFF"}
...
, fig.alt="Scatterplot of bill length vs. flipper length for three species of penguins."
