...
-   [quarto.org](https://quarto.org/docs/guide/)
-   [La page de discussion sur le dépot de code \`quarto-dev/quarto-cli\`](https://github.com/quarto-dev/quarto-cli/discussions)
-   [Awesome Quarto par Mickaël Canouil](https://github.com/mcanouil/awesome-quarto)
